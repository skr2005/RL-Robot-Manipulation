...
eval_env = DummyVecEnv([lambda: Monitor(
    TerminateOnTruncatedWrapper(gym.make("FrankaPickAndPlaceDense-v0", reward_type=reward_type)), "./eval_logs")])
...
model.learn(
    ...
    tb_log_name="sac_franka_pick_and_place_dense"
)

# 保存最终模型
model.save("sac_franka_pick_and_place_dense_final")
